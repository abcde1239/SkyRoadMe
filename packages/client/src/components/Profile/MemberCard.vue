    ...
    <div class="w-120 min-h-50">
      <div class="text-4xl mb-5 color-black font-size-10">
        ...
        <div class="shaow-lg flex flex-col rounded-md bg-slate-50">
          <div class="flex-1/10">
            <img
              class="round-t-md max-height- max-width"
              src="../../../public/img/xsxt.jpg"
            />
          </div>
          ...
          <div class="flex-2/5 flex gap5 p-1">
            ...
            <img
              ...
              src="../../../public/img//linyuan.jpg"
              alt="Avatar"
            />
            <!-- 介绍区-->
            <div class="flex flex-col">
              <h1 class="font-bold text-gray font-size-6">Pixel Ribbit</h1>
              <p class="text-gray-500 font-size-6">A Internet Groups.</p>
            </div>
            <!--链接区-->
